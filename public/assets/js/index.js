...
// Function to get all notes from server
const getNotes = () =>
  fetch('/api/notes', {
    method: 'GET',
    headers: {
...
// Function to render active note
const renderActiveNote = () => {
  hide(saveNoteBtn);
  hide(clearBtn);
...
// Function to initialize variables and add event listeners
const init = () => {
  noteForm = document.querySelector('.note-form');
  noteTitle = document.querySelector('.note-title');
  noteText = document.querySelector('.note-textarea');
